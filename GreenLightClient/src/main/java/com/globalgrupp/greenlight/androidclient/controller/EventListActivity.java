...
//            deleteFolder(dir);
    ...
    public void initChannels() {
        try {
            ...
            for (int i = 0; i < channels.size(); i++) {
                if (channels.get(i).getId().equals(ApplicationSettings.getChannelId())) {
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(final AdapterView<?> parent, View view,
                    ...
                    try {
                        ...
                        ApplicationSettings.setChannelId(item.getId());
    ...
    public void refreshEventList(final Long channelId) {
        ...
        try {
            ...
            ApplicationSettings.setOldEventsId(ll);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                    twitter.shutdown();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (ApplicationSettings.getAuthorizationType() == AuthorizationType.VK) {
    ...
    private void addEventToList(final Long eventId) {
        ...
        try {
            ...
            if (ApplicationSettings.getChannelId() != null &&
                ...
                params.setChannelId(ApplicationSettings.getChannelId());
